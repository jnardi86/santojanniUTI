...
const OradoresCard = ({ data }) => {
    return (
        <div className="min-w-[260px] max-w-[375px] bg-DarkGreen text-White rounded-lg rounded-tl-[100px] mx-5 my-2 px-4 py-10 flex flex-col justify-center items-center">
